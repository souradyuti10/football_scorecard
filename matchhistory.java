...
public class matchhistory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtwr, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 30, 90, -1));
        getContentPane().add(r2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, 155, -1));
        getContentPane().add(r1, new org.netbeans.lib.awtextra.AbsoluteConstraints(98, 161, 155, -1));
        ...
        getContentPane().add(rs1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 150, 37, -1));
        getContentPane().add(rs2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 240, 37, -1));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/soura/images12.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int resp=JOptionPane.showConfirmDialog(null, "Do you want to Search !");
        ...
        try
        {
            ...
            String str="select*From matchhistory where match1="+ txtwr.getText()+";";
       ResultSet rs=stmt.executeQuery(str);
       if(rs.next())
       {
       int R=rs.getInt("match1");
       String n=rs.getString("team1");
       String m=rs.getString("team2");
       int c=rs.getInt("score1");
         int d=rs.getInt("score2");
         txtwr.setText(""+R);     
       r1.setText(""+n);
       r2.setText(""+m);
       rs1.setText(""+c);
...
startframe newra2 =new startframe();
    newra2.setVisible(true);    
